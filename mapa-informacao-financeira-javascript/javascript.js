...
todosCampos.map((el)=>{
    el.addEventListener("change",()=>{
        ...
        let margemBrutoN2 = proveitosN2 - custosN2
        let margemBrutoN1 = proveitosN1 - custosN1
        let margemBrutoA = proveitosA - custosA
        let margemBrutoVs = proveitosVs - proveitosVs
